    ...
    grunt.task.registerTask('createTag', 'Creates a wrapped vast tag if necessary', function() {
      ...
      fs.readFile('src/js/shared-functionsUncompressed.js',"utf-8", function (err,data) {
        ...
        if(source!== null){
          ...
          appendTag = appendTag.replace(/var source = .*?";/,'var source = "https://reports.adspdbl.com/vast-tag-generator/?rdr='+source+'&domain="+completeDomain+"&campaign="+campaign+"&path="+completeUrlformatted[1];//done');
